...
class NerdsIQ_Public {
        ...
        wp_localize_script(
            ...
            array(
                ...
                'strings'                 => array(
                    ...
                    'placeholder'           => get_option( 'nerdsiq_input_placeholder', __( 'Type your message...', 'nerdsiq-ai-assistant' ) ),
    ...
    public function ajax_send_message() {
        error_log('NerdsIQ: ajax_send_message called');
        
        check_ajax_referer( 'nerdsiq_public_nonce', 'nonce' );

        error_log('NerdsIQ: nonce verified');
        ...
        error_log('NerdsIQ: access check - allowed: ' . ($access['allowed'] ? 'yes' : 'no') . ', reason: ' . $access['reason']);
        ...
        $user_id = get_current_user_id();
        error_log('NerdsIQ: user_id = ' . $user_id);
