...
(function($) {
    ...
    class NerdsIQChat {
        ...
        cacheElements() {
            ...
            this.$maximizeBtn = $('#nerdsiq-maximize-btn');
        ...
        bindEvents() {
            ...
            this.$maximizeBtn.on('click', () => this.toggleMaximize());
        ...
        closeChat() {
            ...
            this.isOpen = false;
            // Also restore from maximized state when closing
            this.$chatWindow.removeClass('nerdsiq-maximized');
        ...
        toggleMaximize() {
            this.$chatWindow.toggleClass('nerdsiq-maximized');
            const isMaximized = this.$chatWindow.hasClass('nerdsiq-maximized');
            
            // Update button title
            this.$maximizeBtn.attr('title', isMaximized ? 'Restore' : 'Maximize');
            this.$maximizeBtn.attr('aria-label', isMaximized ? 'Restore chat window' : 'Maximize chat window');
            
            // Log event
            this.logEvent(isMaximized ? 'widget_maximized' : 'widget_restored');
        }
