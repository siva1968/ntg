...
class NerdsIQ_AI_Assistant {
    ...
    private function define_public_hooks() {
        ...
        // Initialize access control for login redirect
        NerdsIQ_Access_Control::init();

        $this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_styles' );
        $this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
        $this->loader->add_action( 'wp_footer', $plugin_public, 'render_chat_widget' );

        // AJAX handlers for public (logged-in users)
        ...
        // AJAX handlers for guests (non-logged-in users)
        $this->loader->add_action( 'wp_ajax_nopriv_nerdsiq_send_message', $plugin_public, 'ajax_send_message' );
        $this->loader->add_action( 'wp_ajax_nopriv_nerdsiq_get_history', $plugin_public, 'ajax_get_history' );
        $this->loader->add_action( 'wp_ajax_nopriv_nerdsiq_reset_conversation', $plugin_public, 'ajax_reset_conversation' );
        $this->loader->add_action( 'wp_ajax_nopriv_nerdsiq_log_event', $plugin_public, 'ajax_log_event' );
    }
