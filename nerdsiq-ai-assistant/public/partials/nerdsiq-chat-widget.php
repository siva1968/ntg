    ...
    <div id="nerdsiq-chat-window" class="nerdsiq-chat-window" style="display: none;" role="dialog" aria-labelledby="nerdsiq-header-title" aria-modal="true">
        ...
        <div class="nerdsiq-header">
            <div class="nerdsiq-header-content">
                ...
                <h3 id="nerdsiq-header-title" class="nerdsiq-header-title"><?php esc_html_e( 'NerdsIQ AI Assistant', 'nerdsiq-ai-assistant' ); ?></h3>
            </div>
        ...
        <!-- Footer -->
        <div class="nerdsiq-footer">
            <small><?php esc_html_e( 'Powered by AWS Q Business', 'nerdsiq-ai-assistant' ); ?></small>
        </div>
    </div>
</div>
